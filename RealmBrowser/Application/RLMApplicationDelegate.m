...
@property (nonatomic, strong) RLMSyncUICoordinator *syncCoordinator;
...
-(void)applicationDidFinishLaunching:(NSNotification *)notification
{
    ...
    self.syncCoordinator = [[RLMSyncUICoordinator alloc] init];
    [self.syncCoordinator configureMainMenuWithSyncItems];
}
